...
function ProjectsPage() {
  ...
  return (
    <section className="mt-20 mx-auto px-4 max-w-screen-xl md:px-8">
      ...
      <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3 shadow-lg">
        {
          posts.map((items, key) => (
            <article className="max-w-md mx-auto mt-4 shadow-lg border rounded-md duration-300 hover:shadow-xl transform hover:scale-105" key={key}>
              <a href={items.href}>
